...
public class AchivmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Cek apakah achievement sudah didapat dari SharedPreferences
        ...
        // Update tampilan berdasarkan status achievement
        ImageView achievement1 = view.findViewById(R.id.achievement1);
        if (isAchieved) {
            achievement1.setImageResource(R.drawable.achivement1_unlocked); // Achievement terbuka
        } else {
            achievement1.setImageResource(R.drawable.achivement_locked); // Achievement terkunci
        }

        // Tombol untuk berpindah ke CollectionFragment
        ...
        return view; // **Hanya ada satu return view di akhir!**
    }
}
